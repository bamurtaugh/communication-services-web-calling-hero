...
Additional documentation for this sample can be found on the [Microsoft Docs](https://docs.microsoft.com/azure/communication-services/samples/calling-hero-sample).
